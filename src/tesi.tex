...
definito (di default \emph{3050}), si \'e fatto in modo che tale port fosse 
accessibile dalla macchina host. Oltre a questo \'e anche possibile l'accesso 
attraverso attraverso \emph{SSH}. Mettendo insieme queste due caratteristiche 
non \'e neccessario avviare l'interfaccia grafica.
...
...A questo punto \'e 
possibile collegarsi a SWISH dalla macchina host usando 
\texttt{http://127.0.0.1:5555} come URL...
...
che si rivelani pi\'u precisi ... cite ... ...
...
\begin{itemize}
    \item usando l'operatore \texttt{<-} seguito dal comando R,
    \item oppure con una notazione chiamata \emph{quasi-quotation}
\end{itemize}
... Cite and same example for both cases here ...

Nel secondo caso \'e possibile gestire alcuni casi particolari che 
genererebbero errori, ad esempio:
