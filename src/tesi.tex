...
Per rappresentare l'intervallo di confidenza si è utilizzata un'istruzione
di ggplot2 che permette di colorare l'area del grafico interessata. 
L'intervallo di confidenza del 95\% è dato da $\bar{y}_{\ast} \pm 
...
\begin{code}
\caption{Disegno dell error bar}
\begin{rcode*}{}
Sigma is 0.3,
sigma <- Sigma,
geom_errorbar(
...
\begin{figure}[H]
\caption{Risultato dell'esecuzione di [TODO]}
\includegraphics[width=.5\linewidth]{gpr_R_plot.png}
\end{figure}

Il codice sorgente completo di gpr\_R.pl si trova \ref{gprRpl}
