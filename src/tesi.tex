...
con cplint e lo stesso scritto con cplint\_r. Nei casi di utilizzo diretto di 
cplint\_r il  codice prolog rimane fondamentalmente invariato rispetto alla 
versione C3.js. Per prima cosa è neccsario includere la libreria.
Bisogna poi chiamare la corrispondente funzione di cplint\_r con gli stessi 
parameteri ad esclusione dell'\emph{oggetto grafico} poichè non necessario. Il 
listato~\ref{lst:diffcoinmsw} è il risultato del comando
