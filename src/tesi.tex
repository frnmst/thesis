...
virtualizzazione chiamato Docker. Inoltre non viene mai esposto un socket \emph{TCP/IP} ma 
solo un socket di tipo \emph{UNIX} [EXPLAIN DIFFERENCE TO SHOW THE ADDED 
SECURITY][FIXME] \cite{unixSocket}. A differenza di socket TCP/IP, 
un socket UNIX. Quest'ultimo aspetto si può vedere 
nel listato~\ref{lst:rservconf} che contiene la configurazione di Rserve.
