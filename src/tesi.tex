...
aspetti una matrice anche perché si possono usare le stesse convenzioni per 
...
documentazione di swish-installer~\cite{swishInstallerInstallation} per capire 
quali sono e come fare per scaricare e installare i pacchetti.
...
repository di rserve-sandbox, sia modificando quest'ultimo con le istruzioni 
e la documentazione necessaria. Per lo stesso motivo precedente si sono dovuti 
...
\chapter{TODO}
\begin{itemize}
    \item Check all bibliography: page number, authors, references, etc...
    \item IF wikipedia: use the "History" page; get a static version of the web 
          pages.
    \item Check accents: http://www.treccani.it/enciclopedia/acuto-o-grave-accento\_\%28La-grammatica-italiana\%29/
    \item Check grammar
\end{itemize}
