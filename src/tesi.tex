...
visualizzazione grafica \cite{r}. Con il termine R si definisce l'interprete
...
Una delle operazioni fondamentali di R è la funzione \mint{r}|c()|
...
I \emph{data frame} sono un tipo particolare di \emph{oggetti} che permettono 
di organizzare i dati sotto forma matriciale \cite{rDataFrame}. 

[TODO]

I data frame sono definiti come specializzazione della classe lista.
...
%passaggio di valori tra Prolog ed R attraverso i \emph{data frame}. 
