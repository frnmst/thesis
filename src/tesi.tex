...
di ambienti isolati basate su utenti singoli. Con Docker in particolare, 
questi ambienti possono essere eseguiti su qualunque macchina in modo 
indipendente dalla configurazione del sistema operativo ospite, a patto che i 
...
con un particolare utilizzo. \cite{DockerfileReference} Partendo da queste 
immagini è anche possibile costruirne di derivate ...cite and expand...

Una volta costruita l'immagine è possibile anche distribuirla. Il vantaggio di 
questo metodo è che l'utente finale è in grado di utilizzare subito l'immagine, 
senza che possano sorgere problemi. Lo svantaggio tuttavia è che l'immagine può 
essere anche molto grande (nell'ordine del Gigabyte) e quindi difficile da 
distribuire con i mezzi di rete più noti.
