...
scala, la rappresentazione estetica, ecc... \cite{grammarOfGraphics} 
\cite{ggplot2}
...
operativo. Questo significa che è possibile l'esistenza di molteplici istanze 
isolate basate su utenti singoli. In Docker queste istanze sono chiamate 
\emph{container}. Questi ambienti possono essere eseguiti su qualunque macchina 
in modo indipendente dalla 
configurazione del sistema operativo cosicché il software che è eseguito al 
loro interno è garantito funzionare in modo affidabile e come lo 
sviluppatore aveva inteso che 
funzionasse.\cite{operatingSystemLevelVirtualization} \cite{docker}

        \subsection{Immagini}
Attraverso un documento di testo chiamato \emph{Dockerfile} è 
possibile far aggiungere programmi, file e utenti per creare un'immagine
...
Quando si esegue un'immagine si ottiene un cotainer...
La comunità di utilizzatori di Docker continua a creare nuove immagini ognuna 
con un particolare utilizzo.
...
principio dell'indicizzazione, sia attraverso l'uso della notezione 
\mint{r}|lista$componente|.
... cite: Page 32, Par 6.1, R-intro.pdf ....
...
di organizzare i dati sotto forma matriciale. ... cite Page 18, Par 2.8, 
R-intro.pdf... 
...
... cite: Page 27, Par 6.3.1, R-intro.pdf ...
