...
\subsection{Funzioni grafiche}
%% transform pseudocode to IT lang.
Le funzioni grafiche invece per prima cosa trasformano i dati in 
...
Infine, sono stati scritti alcuni predicati che aiutano a gestire le 
