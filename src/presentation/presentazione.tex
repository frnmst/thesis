...
\item Per il programma \texttt{gpr\_R.pl} ad esempio si è seguito il 
...
sottografici al contraio della versione C3.js che li raggruppa nello
stesso grafico.
...
\MyLogo
\begin{itemize}
\item L'obbiettivo è stato raggiunto sia con cplint\_r sia con i pacchetti 
software.
